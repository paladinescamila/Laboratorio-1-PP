...
var utils = {
    ...
    getRaceNo: function (dom) {
        ...
        return Number(id.substr(4));
    },

    getRaceJson: function (dom) {
        let no = this.getRaceNo(dom);
    ...
    parseTypeAndName: function (line) {
        let type = "";
        let name = "";
...
var filter = {
    ...
    _hideRace: function (race, idx, node) {
        if (node.node === "function") {
            ...
            let sharedObjName =
                race.sharedObj.name ? race.sharedObj.name : utils.parseTypeAndName(race.sharedObj.sourceLine).name;
...
$(document).ready(function () {
    ...
    $(".filter-var-toggle").on("click", function (e) {
        ...
        let info = utils.parseTypeAndName(sharedObj.sourceLine);
